...
export default function LoginPage() {
  ...
  <h1 className="text-2xl font-semibold text-center text-blue-300  mb-4">Welcome to AMR Construction</h1>
    ...
    <form className="space-y-4">
      ...
      <p className="text-center text-sm text-gray-600 dark:text-gray-400">Don't have an account? <Link href="/signup" className="text-blue-500 hover:text-blue-600">Signup here</Link></p>
    </form>
